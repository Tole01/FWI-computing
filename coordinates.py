...
def pixel_to_gps(pixel_x, pixel_y, img_width, img_height, height_m, drone_lat, drone_lon, fov_x_deg = FOV_TERMICA_HORIZONTAL, fov_y_deg = FOV_TERMICA_VERTICAL):
    """
...
def pixel_to_gps_vectorized(y_pixels, x_pixels, img_width, img_height, d_height, d_lat, d_lon, fov_x_deg = FOV_TERMICA_HORIZONTAL, fov_y_deg = FOV_TERMICA_VERTICAL):
    """
